(define (problem ghost-problem)
   ...
   ;; | | | | | |
   ;; |#|#| | |P|
   ;; In this case, the ghost was sacared (5 seconds remaining.)
   ;; The ghost is supposed to stay where it is until the scaring time goes to zero
   ;; then go for pacman.
